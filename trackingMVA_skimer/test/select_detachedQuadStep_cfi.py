...
detachedQuadStepCutSel = cms.EDProducer("TrackCutClassifier",
    beamspot = cms.InputTag("offlineBeamSpot"),
    ignoreVertices = cms.bool(False),
    mightGet = cms.optional.untracked.vstring,
    mva = cms.PSet(
        dr_par = cms.PSet(
            d0err = cms.vdouble(3.40282346639e+38, 3.40282346639e+38, 3.40282346639e+38),
            d0err_par = cms.vdouble(3.40282346639e+38, 3.40282346639e+38, 3.40282346639e+38),
        ...
        maxDr = cms.vdouble(9999.0, 9999.0, 9999.0),
        maxDz = cms.vdouble(9999.0, 9999.0, 9999.0),
...
detachedQuadStepCutBaseTracks = cms.EDProducer("TrackCollectionMerger",
    allowFirstHitShare = cms.bool(True),
    copyExtras = cms.untracked.bool(False),
    copyTrajectories = cms.untracked.bool(False),
    foundHitBonus = cms.double(10),
    inputClassifiers = cms.vstring(
		'detachedQuadStepCutSel',
    ),
